...
- Slideshow application [installed](https://slideshow.digital/how-to-get-it/) on that device
...
3. Login into Slideshow's [web interface](../web_interface.md).
...
You can also insert [setup.csv](https://slideshow.digital/documentation/setup-csv-file/) file into the ZIP file in order to get more control over which files will be copied.
