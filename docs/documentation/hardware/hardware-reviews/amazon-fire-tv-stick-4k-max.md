...
- Using Downloader app ([https://www.amazon.com/AFTVnews-com-Downloader/dp/B01N0BP507](https://www.amazon.com/AFTVnews-com-Downloader/dp/B01N0BP507)), navigate to [https://slideshow.digital](https://slideshow.digital), click on `Get started` in the menu and `Download`. Downloader will start the installation automatically.
