...
1. Ask your BenQ representative for instructions how to access "Factory mode" on the display. (We got the instructions from our BenQ representative, but they might be region-dependent, but if you are out of luck, [let us know](../../../contact-us/index.md))
...
- Displays are running Android 4.3, which is quite old, and the most recent version of Slideshow you can use is [3.20.3](../../release-notes.md#version-3203). 
