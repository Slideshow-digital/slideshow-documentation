...
[Get SlideShow](index.md){ .md-button .md-button--primary }
...
![](tutorial-screenshot-settings.png)
...
![](tutorial-screenshot-initial.png)
...
![](tutorial-file-manager.webp)

**8.** Explore the documentation and video tutorials to find out more about features
