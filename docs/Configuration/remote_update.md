...
Remote update works only on rooted devices or on devices on which Slideshow app is set as the device owner. Special handling is available for the following non-rooted Android devices:
